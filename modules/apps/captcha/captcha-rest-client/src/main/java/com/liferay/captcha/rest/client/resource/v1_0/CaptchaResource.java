...
public interface CaptchaResource {
	...
	public HttpInvoker.HttpResponse getSimpleCaptchaHttpResponse()
		throws Exception;

	public FormCaptcha validateSimpleCaptcha(FormCaptcha formCaptcha)
		throws Exception;

	public HttpInvoker.HttpResponse validateSimpleCaptchaHttpResponse(
	...
	public static class CaptchaResourceImpl implements CaptchaResource {
		...
		public FormCaptcha validateSimpleCaptcha(FormCaptcha formCaptcha)
			...
			HttpInvoker.HttpResponse httpResponse =
				validateSimpleCaptchaHttpResponse(formCaptcha);
			...
			try {
				return FormCaptchaSerDes.toDTO(content);
			}
			catch (Exception e) {
				_logger.log(
					Level.WARNING,
		...
		public HttpInvoker.HttpResponse validateSimpleCaptchaHttpResponse(
			...
			httpInvoker.body(formCaptcha.toString(), "application/json");
