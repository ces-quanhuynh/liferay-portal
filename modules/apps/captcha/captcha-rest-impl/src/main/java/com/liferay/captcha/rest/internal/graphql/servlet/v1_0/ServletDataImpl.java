...
import com.liferay.captcha.rest.internal.resource.v1_0.CaptchaResourceImpl;
...
public class ServletDataImpl implements ServletData {
	...
	public void activate(BundleContext bundleContext) {
		Mutation.setCaptchaResourceComponentServiceObjects(
			_captchaResourceComponentServiceObjects);

		Query.setCaptchaResourceComponentServiceObjects(
			_captchaResourceComponentServiceObjects);
	}
	...
	private static final Map<String, ObjectValuePair<Class<?>, String>>
		_resourceMethodObjectValuePairs =
			new HashMap<String, ObjectValuePair<Class<?>, String>>() {
				{
					put(
						"mutation#validateSimpleCaptcha",
						new ObjectValuePair<>(
							CaptchaResourceImpl.class,
							"validateSimpleCaptcha"));

					put(
						"query#simpleCaptcha",
						new ObjectValuePair<>(
							CaptchaResourceImpl.class, "getSimpleCaptcha"));
				}
			};

	@Reference(scope = ReferenceScope.PROTOTYPE_REQUIRED)
	private ComponentServiceObjects<CaptchaResource>
		_captchaResourceComponentServiceObjects;
