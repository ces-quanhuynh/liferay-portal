...
public class CaptchaSAPEntryPortalInstanceLifecycleListener
	...
	private void _addSAPEntry(long companyId) throws PortalException {
		String name = _SAP_ENTRY_OBJECT_ENTRY[0];
		...
		Map<Locale, String> map = ResourceBundleUtil.getLocalizationMap(
			...
			"service-access-policy-entry-default-captcha-entry-title");

		_sapEntryLocalService.addSAPEntry(
			_userLocalService.getGuestUserId(companyId),
			_SAP_ENTRY_OBJECT_ENTRY[1], true, true, name, map,
			new ServiceContext());
	}

	private static final String[] _SAP_ENTRY_OBJECT_ENTRY = {
		"CAPTCHA_DEFAULT",
