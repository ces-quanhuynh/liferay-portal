...
public abstract class BaseCaptchaResourceTestCase {
	...
	protected void assertContains(Object captcha, List<Object> captchas) {
		boolean contains = false;

		for (Object item : captchas) {
	...
	protected void assertEquals(Object captcha1, Object captcha2) {
		Assert.assertTrue(
	...
	protected void assertEquals(
		List<Object> captchas1, List<Object> captchas2) {

		Assert.assertEquals(captchas1.size(), captchas2.size());

		for (int i = 0; i < captchas1.size(); i++) {
			Object captcha1 = captchas1.get(i);
			Object captcha2 = captchas2.get(i);
	...
	protected void assertEqualsIgnoringOrder(
		...
		for (Object captcha1 : captchas1) {
			boolean contains = false;

			for (Object captcha2 : captchas2) {
	...
	protected void assertValid(Object captcha) throws Exception {
		boolean valid = true;
	...
	protected void assertValid(
		...
		java.util.Collection<Object> captchas = page.getItems();
	...
	protected boolean equals(Object captcha1, Object captcha2) {
	...
	protected String getFilterString(
		EntityField entityField, String operator, Object captcha) {
