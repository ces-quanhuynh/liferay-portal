 ...
 */
@Generated("")
@GraphQLName("FormCaptcha")
@JsonFilter("Liferay.Vulcan")
@Schema(requiredProperties = {"captchaToken"})
@XmlRootElement(name = "FormCaptcha")
public class FormCaptcha implements Serializable {

	public static FormCaptcha toDTO(String json) {
		return ObjectMapperUtil.readValue(FormCaptcha.class, json);
	}

	public static FormCaptcha unsafeToDTO(String json) {
		return ObjectMapperUtil.unsafeReadValue(FormCaptcha.class, json);
	}
	...
	@Schema(
		...
		defaultValue = "com.liferay.captcha.rest.dto.v1_0.FormCaptcha",
		name = "x-class-name"
	)
